          ...
          <div className="bg-white shadow rounded-lg p-6 max-w-xl">
            <form className="space-y-4" onSubmit={handleLogin}>
              ...
              <p className="text-xs text-gray-600">
                Defaults: <span className="font-mono">{DEFAULT_USERNAME}</span> /
                <span className="font-mono">{DEFAULT_PASSCODE}</span>. Set
                <code className="bg-gray-200 px-1 rounded ml-1">REACT_APP_ADMIN_USERNAME</code> and
                <code className="bg-gray-200 px-1 rounded ml-1">REACT_APP_ADMIN_PASSCODE</code> to use your own credentials.
              </p>
